...
def versions():
    try:
		print('**When using DEBM in a paper, please cite: Yakobi, O., & Roth, Y. (2022, January 10). Decision from Experience Behavior Modeling (DEBM): an open-source Python package for developing, evaluating, and visualizing behavioral models. https://doi.org/10.31234/osf.io/3emdw')
